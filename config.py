...
ice_channel_dataset = dataset_base.copy({
    'name': 'Ice Channel',

    'train_images': '/media/dwb/media/cloned/yolact/dataset/hangdao_pic_opt',
    'train_info':   '/media/dwb/media/cloned/yolact/dataset/hangdao_pic_opt/annotations.json',

    'valid_images': '/media/dwb/media/cloned/yolact/dataset/hangdao_pic_opt',
    'valid_info':   '/media/dwb/media/cloned/yolact/dataset/hangdao_pic_opt/annotations.json',
...
zhongliu_dataset = dataset_base.copy({
    ...
    'train_images': '/media/dwb/media/cloned/yolact/dataset/zhouliu_xunlian/train',
    'train_info':   '/media/dwb/media/cloned/yolact/dataset/zhouliu_xunlian/train/annotations.json',

    'valid_images': '/media/dwb/media/cloned/yolact/dataset/zhouliu_xunlian/val',
    'valid_info':   '/media/dwb/media/cloned/yolact/dataset/zhouliu_xunlian/val/annotations.json',
...
zhongliu_test_dataset = dataset_base.copy({
    'name': 'zhongliu_test',

    'train_images': '/media/dwb/media/cloned/yolact/dataset/zhouliu_xunlian/train',
    'train_info':   '/media/dwb/media/cloned/yolact/dataset/zhouliu_xunlian/train/annotations.json',

    'valid_images': '/media/dwb/media/cloned/yolact/dataset/zhouliu_xunlian/train',
    'valid_info':   '/media/dwb/media/cloned/yolact/dataset/zhouliu_xunlian/train/annotations.json',
...
yolact_resnet50_ice_channel_config = yolact_resnet50_config.copy({
    'name': 'yolact_resnet50_ice_channel_config',
    # Dataset stuff
    'dataset': ice_channel_dataset,
    'num_classes': len(ice_channel_dataset.class_names) + 1,
...
yolact_resnet50_zhongliu = yolact_resnet50_config.copy({
    'name': 'yolact_resnet50_zhongliu',
    # Dataset stuff
    'dataset': zhongliu_dataset,
    'num_classes': len(zhongliu_dataset.class_names) + 1,
